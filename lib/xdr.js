...
XDR.prototype = {
  ...
  readUInt64: function( offset ) {
    ...
    var lo = this.buffer.readUInt32BE( this.offset )
    this.offset += 4
  ...
  writeUInt64: function( value, offset ) {
    ...
    this.offset = offset
    this.buffer.writeInt32BE( ( hi >> 0 ), this.offset )
    this.offset += 4
    this.buffer.writeInt32BE( ( lo >> 0 ), this.offset )
    this.offset += 4
  ...
  writeBuffer: function( value, offset ) {
    return this.writeBytes( value, offset )
  },
